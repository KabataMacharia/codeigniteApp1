		...
		<div class="well">
			<form action="<?php echo base_url('forgot-password') ?>" method="post" id="reset-email-form" data-parsley-validate>
				...
				<div class="form-group">
					<label>Email</label>
					<input type="text" name="reset_email" class="form-control" data-parsely-required>
				</div>
				...
				<button type="submit" id="reset_email_submit" data-loading-text="Sending email... <i class='fa fa-spinner fa-pulse fa-fw'></i>" class="btn btn-primary btn-block btn-raised" autocomplete="off">
				  Submit
				</button>
			</form>
